...
const navigation = [
	{ name: "O nama", href: "#onama", current: true },
	{ name: "Naš tim", href: "#tim", current: false },
	{ name: "Suradnje", href: "#suradnje", current: false },
	{ name: "Fotogalerija", href: "#fotogalerija", current: false },
];
					...
					<div className="relative flex h-20 items-center justify-between">
						...
						<div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
							...
							<Menu as="div" className="relative ml-3">
								<div>
									<MenuButton className="relative flex rounded-full bg-gray-800 p-1  text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2 focus:ring-offset-white text-gray-300 hover:text-white">
										<span className="absolute -inset-1.5" />
