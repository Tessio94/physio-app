...
function Gallery() {
	...
	return (
		<section className="relative h-[100vh] w-[100vw] overflow-hidden">
			<div
				id="container"
				className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] h-full w-full bg-slate-500 shadow-xl"
			>
				...
				<div className="button flex items-center justify-center gap-10 text-center absolute bottom-[15%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
					<button
