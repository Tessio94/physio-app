      ...
      >
        <div className="slide">
          {slideOrder.map((slide, i) => {
            return (
              <div
                className="item w-[200px] h-[300px] absolute top-[50%] translate-x-0 translate-y-[-50%] rounded-xl shadow-xl shadow-black bg-cover bg-center inline-block transition-all duration-300"
                key={i}
